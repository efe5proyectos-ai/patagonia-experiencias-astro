            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                ...
                <div class="col-span-1 lg:col-span-2">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <div class="flex items-center gap-2 bg-white/5 border border-white/10 rounded-lg px-3 py-2">
                            <i class="fa-solid fa-credit-card text-blue-300 text-xs"></i>
                            <span class="text-[10px] text-gray-300 uppercase tracking-widest font-semibold">Pagos con MercadoPago</span>
                        </div>
                        <div class="flex items-center gap-2 bg-white/5 border border-white/10 rounded-lg px-3 py-2">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li><a href="https://wa.me/5492804687904" target="_blank" rel="noopener" class="hover:text-white transition-colors flex items-center gap-2"><i class="fa-brands fa-whatsapp" style="color:#E91E63;"></i> +54 9 2804 68-7904</a></li>
                ...
                <div>
                    ...
                    <h4 class="text-white font-bold mt-8 mb-4 uppercase tracking-widest text-xs">Colaboradores</h4>
                    <div class="flex flex-wrap gap-4 items-center">
                        <img src="./logo-cat-chubut.png" alt="CAT Chubut - Cámara de Turismo Chubut" loading="lazy" class="h-10 w-auto object-contain" />
                        <img src="./logo-agencia-turismo-chubut.png" alt="Chubut Patagonia - Agencia de Turismo" loading="lazy" class="h-10 w-auto object-contain" />
                    </div>
                </div>
            </div>
